...
struct Cash: View {
    ...
    var body: some View {
        ZStack {
            LinearGradient(gradient: Gradient(colors: [cashFirstColor, cashSecondColor, cashThirdColor]), startPoint: .top, endPoint: .trailing).edgesIgnoringSafeArea(.all)
            ...
            VStack {
                ...
                KeypadView(amount: $model.changeString)
